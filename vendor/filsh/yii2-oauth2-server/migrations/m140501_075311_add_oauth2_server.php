...
//                $this->primaryKey('client_id'),
            ...
            $this->addPrimaryKey('client_id','{{%oauth_clients}}','client_id');
...
//                $this->primaryKey('access_token'),
            ...
            $this->addPrimaryKey('access_token','{{%oauth_access_tokens}}','access_token');
...
//                $this->primaryKey('refresh_token'),
            ...
            $this->addPrimaryKey('refresh_token','{{%oauth_refresh_tokens}}','refresh_token');
...
//                $this->primaryKey('authorization_code'),
            ...
            $this->addPrimaryKey('authorization_code','{{%oauth_authorization_codes}}','authorization_code');
...
//                $this->primaryKey('client_id'),
            ...
            $this->addPrimaryKey('client_id','{{%oauth_jwt}}','client_id');
